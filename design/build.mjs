...
import { MOCK_METHOD, SAMPLE_WAVE } from './mock.mjs';
...
const files = {
  ...
  'WebEditor': ['Web · Card editor', webEditor, { props: { ...DARK, cardType: { editor: 'enum', default: 'Basic', options: ['Basic', 'Blank', 'Image', 'Audio'] }, recording: { editor: 'boolean', default: false }, slashDemo: { editor: 'boolean', default: false } }, logic: EDITOR_LOGIC, css: RICH_CSS, w: W, h: H }],
  ...
  'WebEditorRecording': ['Web · Card editor · recording audio', attrOf('WebEditor', W, H, 'card-type="Audio" recording="{{yes}}"'), { logic: darkLogic, css: RICH_CSS, w: W, h: H }],
  ...
  'PhoneEditor': ['iPhone · Card editor', phoneEditor, { props: { ...DARK, keyboard: { editor: 'boolean', default: true }, textStyles: { editor: 'boolean', default: false }, cardType: { editor: 'enum', default: 'Basic', options: ['Basic', 'Blank', 'Image', 'Audio'] }, recording: { editor: 'boolean', default: false } }, logic: EDITOR_LOGIC, css: RICH_CSS, w: PW, h: PH }],
  'PhoneEditorAudio': ['iPhone · Card editor · audio', attrOf('PhoneEditor', PW, PH, 'card-type="Audio" keyboard="{{no}}"'), { logic: yesNoLogic, css: RICH_CSS, w: PW, h: PH }],
  'PhoneEditorRecording': ['iPhone · Card editor · recording audio', attrOf('PhoneEditor', PW, PH, 'card-type="Audio" keyboard="{{no}}" recording="{{yes}}"'), { logic: yesNoLogic, css: RICH_CSS, w: PW, h: PH }],
