...
// Tags on a deck or card: x removes one. Add tag opens the picker: a menu on web (always 320 wide; in the card editor
// it used to shrink to the Add tag button's width), its own sheet on iPhone.
