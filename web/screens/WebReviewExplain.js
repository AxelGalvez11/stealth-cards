// Made from design/canvas/project/WebReviewExplain.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebReviewExplain", title: "Web · Review · Explain (AI explains the answer)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebReview"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebReview\" start-revealed=\"{{yes}}\" explain-open=\"{{yes}}\" explained=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
