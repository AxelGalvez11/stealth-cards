// Made from design/canvas/project/TopTodayDark.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "TopTodayDark", title: "Top tabs · Today (dark)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["TopToday"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #000000;\"><dc-import name=\"TopToday\" dark=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
