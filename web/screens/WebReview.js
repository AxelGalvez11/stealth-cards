...
export default {
  ...
  props: {"dark":false,"grading":"Four buttons","card":"Basic","startRevealed":false,"fsrs":true,"progress":"Bar","settingsOpen":false,"newPileOpen":false,"radius":32},
  imports: [],
...
mock() {
  ...
  return {
    ...
    ai: () => ({ url: 'https://[YOUR-DOMAIN]/mcp', perms, clients: { claude: true, openai: true, cursor: false, mcp: false }, connected: 'Claude, ChatGPT' }),
