...
renderVals() {
  ...
  return {
    ...
    bars: [4,5,9,16,7,5,23,21,16,20,10,18,39,21,11,26,22,31,37,9,15,40,28,25,25,10,29,42,16,15,24,18,30,26,4,15,25,15,15,10,4,12,8,4].map((h, i) => ({ h: h + 'px', anim: playing ? 'scWave .9s ease-in-out ' + ((i % 5) * 0.12).toFixed(2) + 's infinite alternate' : 'none' }))
  };
}
}
return Component;
