// Made from design/canvas/project/WebStatsDark.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebStatsDark", title: "Web · Stats (dark)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebStats"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #000000;\"><dc-import name=\"WebStats\" dark=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
