// Made from design/canvas/project/WebQuizDone.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebQuizDone", title: "Web · Learn mode · all learned", w: 1440, h: 900, fill: true,
  props: {"dark":false},
  imports: [],
  ...
  template: "<div style=\"width: 100%; height: 100vh; box-sizing: border-box; display: flex; align-items: center; justify-content: center; font-family: Geist, -apple-system, system-ui, sans-serif; background: {{t.bg}}; color: {{t.text}};\">\n  <main style=\"overflow-y: auto; width: 560px; display: flex; flex-direction: column; align-items: center; gap: 24px; text-align: center;\">\n    <div style=\"position: relative; width: 190px; height: 190px;\"><svg width=\"190\" height=\"190\" viewBox=\"0 0 190 190\" aria-hidden=\"true\"><circle cx=\"95\" cy=\"95\" r=\"87\" fill=\"none\" stroke=\"{{t.surf2}}\" stroke-width=\"16\"/><circle class=\"sc-draw\" pathLength=\"1\" transform=\"rotate(-90 95 95)\" cx=\"95\" cy=\"95\" r=\"87\" fill=\"none\" stroke=\"{{ring}}\" stroke-width=\"16\" stroke-linecap=\"round\"/></svg><div style=\"position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center;\"><span style=\"font-size: 41px; font-weight: 600; letter-spacing: -.04em; line-height: 1;\">40/40</span><span style=\"margin-top: 4px; font-size: 13px; color: {{t.muted}};\">learned</span></div></div>\n    <div style=\"display: flex; flex-direction: column; gap: 8px;\"><h1 style=\"margin: 0; font-size: 32px; font-weight: 600; letter-spacing: -.03em;\">You learned all 40 cards</h1><div style=\"font-size: 16px; color: {{t.muted}};\">Exam 1 · 26 minutes · 88% right the first time</div></div>\n    <div style=\"width: 100%; box-sizing: border-box; padding: 14px 16px; border-radius: 18px; background: {{t.surf}}; display: flex; align-items: center; gap: 12px; text-align: left; font-size: 14px; line-height: 1.45;\"><span style=\"width: 36px; height: 36px; flex-shrink: 0; border-radius: 18px; background: {{t.bg}}; display: flex; align-items: center; justify-content: center;\"><svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><circle cx=\"12\" cy=\"12\" r=\"9\"/><path d=\"M12 7v5l3 2\"/></svg></span>They’re in your reviews now. Lucida brings each card back right before you’d forget it.</div>\n    <div style=\"width: 100%; display: flex; flex-direction: column; gap: 10px; text-align: left;\"><span style=\"font-size: 15px; font-weight: 600;\">Took the most tries</span><sc-for list=\"{{tries}}\" as=\"m\" hint-placeholder-count=\"2\"><div style=\"box-sizing: border-box; padding: 14px 16px; border-radius: 18px; background: {{t.surf}}; display: flex; align-items: center; justify-content: space-between; gap: 12px;\"><span style=\"min-width: 0; font-size: 15px; line-height: 1.35;\">{{m.front}} <span style=\"color: {{t.muted}};\">→</span> <span style=\"font-weight: 600;\">{{m.back}}</span></span><span style=\"flex-shrink: 0; font-size: 13px; color: {{t.muted}};\">{{m.n}}</span></div></sc-for></div>\n    <div style=\"width: 100%; display: flex; gap: 10px;\"><a href=\"WebQuizStart.dc.html\" style=\"flex-grow: 1; height: 52px; border-radius: 999px; background: {{t.surf}}; color: {{t.text}}; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 15px; font-weight: 600; \">Learn more cards</a><a href=\"WebDeck.dc.html\" style=\"flex-grow: 1; height: 52px; border-radius: 999px; background: {{t.inv}}; color: {{t.invText}}; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 15px; font-weight: 600; \">Done</a></div>\n  </main>\n</div>",
  Logic: DCLogic => {
