// Made from design/canvas/project/WebStatsGray.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebStatsGray", title: "Web · Stats (dark, gray)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebStats"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #1E1E20;\"><dc-import name=\"WebStats\" dark=\"{{yes}}\" dim=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
