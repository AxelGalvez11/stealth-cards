// Made from design/canvas/project/WebDecksMoreTags.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebDecksMoreTags", title: "Web · Library · More (find any tag)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebDecks"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebDecks\" more-tags=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
