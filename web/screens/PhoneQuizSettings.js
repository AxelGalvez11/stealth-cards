// Made from design/canvas/project/PhoneQuizSettings.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneQuizSettings", title: "iPhone · Learn mode · settings (the deck’s background)", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneQuiz"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden;\"><dc-import name=\"PhoneQuiz\" settings-open=\"{{yes}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
