// Made from design/canvas/project/PhoneReviewExplain.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneReviewExplain", title: "iPhone · Review · Explain (AI explains the answer)", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneReview"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden;\"><dc-import name=\"PhoneReview\" start-revealed=\"{{yes}}\" explain-open=\"{{yes}}\" explained=\"{{yes}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
