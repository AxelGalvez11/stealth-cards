// Made from design/canvas/project/WebReviewDark.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebReviewDark", title: "Web · Review (dark)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebReview"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #000000;\"><dc-import name=\"WebReview\" dark=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
