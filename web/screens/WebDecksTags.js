// Made from design/canvas/project/WebDecksTags.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebDecksTags", title: "Web · Library · a deck with 11 tags (+9 shows them all)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebDecks"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebDecks\" open-tags=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
