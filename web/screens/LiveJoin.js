// Made from design/canvas/project/LiveJoin.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "LiveJoin", title: "Live · phone · join", w: 390, h: 844, fill: false,
  props: {"dark":false},
  imports: [],
  ...
  template: "<div class=\"sc-live\" style=\"position: relative; width: 390px; height: 844px; box-sizing: border-box; font-family: Geist, -apple-system, system-ui, sans-serif; background: #7ACFEA; color: #0D1542; overflow: hidden; padding: 72px 20px 34px; display: flex; flex-direction: column; gap: 28px; background: linear-gradient(180deg, #86BDF3 0%, #C9E2FB 45%, #EDF5FE 75%, #FFFFFF 100%);\">\n  <div style=\"display: flex; align-items: center; gap: 9px;\"><svg width=\"15\" height=\"14\" viewBox=\"0 0 33 30.5\" fill=\"currentColor\" aria-hidden=\"true\" style=\"flex-shrink: 0; display: block;\"><circle cx=\"7\" cy=\"7\" r=\"7\"/><circle cx=\"26\" cy=\"7\" r=\"7\"/><circle cx=\"16.5\" cy=\"23.45\" r=\"7\"/></svg><div style=\"font-size: 17px; font-weight: 600; letter-spacing: -.02em;\">Lucida</div></div>\n  <div style=\"display: flex; flex-direction: column; gap: 10px;\"><h1 style=\"margin: 0; font-size: 36px; font-weight: 700; line-height: 1.08; letter-spacing: -.03em;\">Join a live game</h1><span style=\"font-size: 16px; line-height: 1.45; color: rgba(13,21,66,.68);\">Type the code on the big screen. No account needed.</span></div>\n  <div style=\"display: flex; flex-direction: column; gap: 8px;\"><span style=\"font-size: 13px; font-weight: 700;\">Code</span><label style=\"position: relative; display: flex; justify-content: space-between; gap: 6px; cursor: text;\"><sc-for list=\"{{boxes}}\" as=\"b\" hint-placeholder-count=\"6\"><span style=\"flex: 0 1 50px; min-width: 0; height: 58px; border-radius: 14px; background: #FFFFFF; box-shadow: 0 10px 24px -16px rgba(13,21,66,.35); display: flex; align-items: center; justify-content: center; font-size: 24px; font-weight: 700;\">{{b.digit}}</span></sc-for><input type=\"text\" inputmode=\"numeric\" autocomplete=\"one-time-code\" maxlength=\"6\" value=\"{{code}}\" onChange=\"{{setCode}}\" aria-label=\"6-digit code\" style=\"position: absolute; inset: 0; width: 100%; opacity: 0; border: 0; padding: 0; font-size: 16px;\"></label></div>\n  <label style=\"display: flex; flex-direction: column; gap: 8px;\"><span style=\"font-size: 13px; font-weight: 700;\">Your name</span><input type=\"text\" value=\"Maya\" aria-label=\"Your name\" style=\"height: 56px; box-sizing: border-box; padding: 0 20px; border: 0; outline: 0; border-radius: 999px; background: #FFFFFF; box-shadow: 0 10px 24px -16px rgba(13,21,66,.35); color: #0D1542; font: inherit; font-size: 16px; font-weight: 600;\"></label>\n  <div style=\"flex-grow: 1;\"></div>\n  <a href=\"LiveWaiting.dc.html\" style=\"height: 58px; padding: 0 26px; display: inline-flex; align-items: center; justify-content: center; gap: 8px; border-radius: 999px; background: #0D1542; color: #FFFFFF; font-size: 17px; font-weight: 600; \">Join</a>\n</div>",
  Logic: DCLogic => {
