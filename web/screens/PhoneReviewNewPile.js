// Made from design/canvas/project/PhoneReviewNewPile.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneReviewNewPile", title: "iPhone · Review · New pile popup", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneReview"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden;\"><dc-import name=\"PhoneReview\" grading=\"Piles\" start-revealed=\"{{yes}}\" new-pile-open=\"{{yes}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
