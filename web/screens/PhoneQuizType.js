...
renderVals() { const t = this.theme(!!this.props.dark);
  ...
  return { t, dark: !!this.props.dark, learned: String(18 + (this.state.gained || 0)), total: '40', setName: 'Exam 1', doneW: (18 + (this.state.gained || 0)) / 40 * 100 + '%', partW: '22.5%',
    bar: this.props.dark ? { done: '#8C9AFC', part: '#3A4BB0' } : { done: '#4353E0', part: '#B0BAFB' }, kind: 'Type the answer', dots: [0, 1].map(i => ({ bg: i < (c && ok ? 2 : 1) ? (this.props.dark ? '#8C9AFC' : '#4353E0') : t.surf2 })),
