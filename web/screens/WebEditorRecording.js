// Made from design/canvas/project/WebEditorRecording.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebEditorRecording", title: "Web · Card editor · recording audio", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebEditor"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebEditor\" card-type=\"Audio\" recording=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
