// Made from design/canvas/project/PhoneReviewGray.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneReviewGray", title: "iPhone · Review (dark, gray)", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneReview"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden; background: #1E1E20;\"><dc-import name=\"PhoneReview\" dark=\"{{yes}}\" dim=\"{{yes}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
