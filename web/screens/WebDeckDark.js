// Made from design/canvas/project/WebDeckDark.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebDeckDark", title: "Web · Deck page (dark)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebDeck"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #000000;\"><dc-import name=\"WebDeck\" dark=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
