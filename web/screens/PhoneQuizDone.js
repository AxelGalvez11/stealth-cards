// Made from design/canvas/project/PhoneQuizDone.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneQuizDone", title: "iPhone · AI quiz · results", w: 390, h: 844, fill: false,
  props: {"dark":false},
  imports: [],
  ...
  template: "<div style=\"position: relative; width: 390px; height: 844px; box-sizing: border-box; font-family: Geist, -apple-system, system-ui, sans-serif; background: {{t.bg}}; color: {{t.text}}; overflow: hidden;\">\n<div style=\"height: 100%; box-sizing: border-box; padding: 64px 20px 34px; display: flex; flex-direction: column; align-items: center; gap: 22px; text-align: center;\">\n  <div style=\"position: relative; width: 160px; height: 160px;\"><svg width=\"160\" height=\"160\" viewBox=\"0 0 160 160\" aria-hidden=\"true\"><circle cx=\"80\" cy=\"80\" r=\"73\" fill=\"none\" stroke=\"{{t.surf2}}\" stroke-width=\"14\"/><path class=\"sc-draw\" pathLength=\"1\" d=\"M 80 7 A 73 73 0 1 1 10.6 57.4\" fill=\"none\" stroke=\"{{ring}}\" stroke-width=\"14\" stroke-linecap=\"round\"/></svg><div style=\"position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center;\"><span style=\"font-size: 36px; font-weight: 600; letter-spacing: -.04em; line-height: 1;\">8/10</span><span style=\"margin-top: 4px; font-size: 13px; color: {{t.muted}};\">right</span></div></div>\n  <div style=\"display: flex; flex-direction: column; gap: 6px;\"><div style=\"font-size: 30px; font-weight: 700; letter-spacing: -.03em;\">Quiz done</div><div style=\"font-size: 15px; color: {{t.muted}};\">8 of 10 right · 4 min · Cell Biology</div></div>\n  <div style=\"width: 100%; display: flex; flex-direction: column; gap: 10px; text-align: left;\"><span style=\"font-size: 15px; font-weight: 600;\">Worth another look</span><sc-for list=\"{{missed}}\" as=\"m\" hint-placeholder-count=\"2\"><div style=\"box-sizing: border-box; padding: 14px 16px; border-radius: 18px; background: {{t.surf}}; display: flex; flex-direction: column; gap: 6px;\"><span style=\"font-size: 15px; font-weight: 500; line-height: 1.35;\">{{m.q}}</span><span style=\"font-size: 13px; color: {{t.muted}};\">You said <span style=\"color: {{t.again}}; font-weight: 600;\">{{m.said}}</span> · Answer <span style=\"color: {{t.good}}; font-weight: 600;\">{{m.answer}}</span></span></div></sc-for></div>\n  <div style=\"flex-grow: 1;\"></div>\n  <div style=\"width: 100%; display: flex; flex-direction: column; gap: 10px;\"><a href=\"PhoneReview.dc.html\" style=\"flex-grow: 0; height: 52px; border-radius: 999px; background: {{t.surf}}; color: {{t.text}}; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 15px; font-weight: 600;\">Study these 2 cards</a><div style=\"display: flex; gap: 10px;\"><a href=\"PhoneQuizStart.dc.html\" style=\"flex-grow: 1; height: 52px; border-radius: 999px; background: {{t.surf}}; color: {{t.text}}; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 15px; font-weight: 600;\">New quiz</a><a href=\"PhoneDeck.dc.html\" style=\"flex-grow: 1; height: 52px; border-radius: 999px; background: {{t.inv}}; color: {{t.invText}}; display: flex; align-items: center; justify-content: center; gap: 8px; font-size: 15px; font-weight: 600;\">Done</a></div></div>\n</div>\n\n\n</div>",
  Logic: DCLogic => {
