// Made from design/canvas/project/WebTodayCaughtUp.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebTodayCaughtUp", title: "Web · Today · all caught up", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["Main"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"Main\" caught-up=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
