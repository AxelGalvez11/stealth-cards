// Made from design/canvas/project/WebTodayDark.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebTodayDark", title: "Web · Today (dark)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["Main"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #000000;\"><dc-import name=\"Main\" dark=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
