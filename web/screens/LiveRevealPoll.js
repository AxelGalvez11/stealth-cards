// Made from design/canvas/project/LiveRevealPoll.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "LiveRevealPoll", title: "Live · big screen · answer (Poll)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["LiveReveal"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"LiveReveal\" mode=\"Poll\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
