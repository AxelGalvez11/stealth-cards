// Made from design/canvas/project/WebReviewImage.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebReviewImage", title: "Web · Review · picture with hidden parts (click the card or press Space)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebReview"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebReview\" card=\"Image\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
