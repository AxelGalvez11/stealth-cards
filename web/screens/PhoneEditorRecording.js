// Made from design/canvas/project/PhoneEditorRecording.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneEditorRecording", title: "iPhone · Card editor · recording audio", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneEditor"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden;\"><dc-import name=\"PhoneEditor\" card-type=\"Audio\" keyboard=\"{{no}}\" recording=\"{{yes}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
