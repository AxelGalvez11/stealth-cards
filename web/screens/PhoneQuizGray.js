// Made from design/canvas/project/PhoneQuizGray.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneQuizGray", title: "iPhone · Learn mode (dark, gray)", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneQuiz"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden; background: #1E1E20;\"><dc-import name=\"PhoneQuiz\" dark=\"{{yes}}\" dim=\"{{yes}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
