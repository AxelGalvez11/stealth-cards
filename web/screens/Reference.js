// Made from design/canvas/project/Reference.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "Reference", title: "Your reference", w: 1440, h: 1110, fill: false,
  props: {},
  imports: [],
  ...
  template: "<div style=\"width: 1440px; height: 1110px; overflow: hidden; background: #FFFFFF;\"><img src=\"/_blob/b36d0110fdee9533cc5677ceb6b78d3d\" alt=\"Reference: blurred green and gold gradient with grain and chat bubbles\" width=\"1440\" height=\"1110\" style=\"display: block; width: 1440px; height: 1110px; object-fit: cover;\"></div>",
  Logic: DCLogic => {
