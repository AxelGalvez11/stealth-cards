// Made from design/canvas/project/WebEditorBigImageDark.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebEditorBigImageDark", title: "Web · Bigger card editor · image with boxes (dark, mockup)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebEditorBig"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebEditorBig\" card-type=\"Image\" dark=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
