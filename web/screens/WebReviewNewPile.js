// Made from design/canvas/project/WebReviewNewPile.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebReviewNewPile", title: "Web · Review · New pile popup", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebReview"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebReview\" grading=\"Piles\" start-revealed=\"{{yes}}\" new-pile-open=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
