// Made from design/canvas/project/PhoneEditorImage.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneEditorImage", title: "iPhone · Card editor · image with boxes", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneEditor"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden;\"><dc-import name=\"PhoneEditor\" card-type=\"Image\" keyboard=\"{{no}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
...
renderVals() { return { yes: true, no: false }; }
}
return Component;
  }
};
