// Made from design/canvas/project/WebLibraryNewFolder.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebLibraryNewFolder", title: "Web · Library · new folder, and a deck’s ⋯ menu", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebDecks"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebDecks\" naming=\"{{yes}}\" move-open=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
