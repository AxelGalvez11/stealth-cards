// Made from design/canvas/project/FocusHomeDark.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "FocusHomeDark", title: "Focus · Home (dark)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["FocusHome"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #000000;\"><dc-import name=\"FocusHome\" dark=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
