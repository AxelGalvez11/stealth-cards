// Made from design/canvas/project/PhoneDeckMoveTray.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "PhoneDeckMoveTray", title: "iPhone · Deck · Move to tray (while a card is dragged)", w: 390, h: 844, fill: false,
  props: {},
  imports: ["PhoneDeck"],
  ...
  template: "<div style=\"width: 390px; height: 844px; overflow: hidden;\"><dc-import name=\"PhoneDeck\" tray-open=\"{{yes}}\" hint-size=\"390px,844px\"></dc-import></div>",
  Logic: DCLogic => {
