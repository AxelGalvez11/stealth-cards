...
constructor(props) { super(props); this.state = { email: '', code: '482', resent: false }; }
renderVals() { const t = this.theme(!!this.props.dark);
  const s = this.state, code = String(s.code || '');
  return { hero: this.mesh(this.props.gradient ?? 'Iris'), grain: String(this.props.grain ?? 0.7), t,
