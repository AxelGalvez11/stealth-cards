// Made from design/canvas/project/WebQuizGray.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebQuizGray", title: "Web · Learn mode (dark, gray)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebQuiz"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden; background: #1E1E20;\"><dc-import name=\"WebQuiz\" dark=\"{{yes}}\" dim=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
