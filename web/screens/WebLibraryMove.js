// Made from design/canvas/project/WebLibraryMove.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebLibraryMove", title: "Web · Library · a deck’s ⋯ menu (move it to a folder)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebDecks"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebDecks\" move-open=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
