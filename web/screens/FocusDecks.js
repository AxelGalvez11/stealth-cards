// Made from design/canvas/project/FocusDecks.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "FocusDecks", title: "Focus · Decks sheet", w: 1440, h: 900, fill: true,
  props: {"dark":false},
  imports: [],
...
renderVals() { const t = this.theme(!!this.props.dark); return { t, decks: [
