// Made from design/canvas/project/WebDeckSettingsStudy.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebDeckSettingsStudy", title: "Web · Deck settings · Studying (FSRS)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebDeck"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebDeck\" settings-open=\"{{yes}}\" settings-tab=\"Studying\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
