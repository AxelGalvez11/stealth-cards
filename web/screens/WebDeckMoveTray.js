// Made from design/canvas/project/WebDeckMoveTray.dc.html by design/to-web.mjs. Change the design, not this file.
export default {
  name: "WebDeckMoveTray", title: "Web · Deck · Move to tray (while a card is dragged)", w: 1440, h: 900, fill: true,
  props: {},
  imports: ["WebDeck"],
  ...
  template: "<div style=\"width: 100%; height: 100vh; overflow: hidden;\"><dc-import name=\"WebDeck\" tray-open=\"{{yes}}\" hint-size=\"1440px,900px\"></dc-import></div>",
  Logic: DCLogic => {
