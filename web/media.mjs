...
// What a file really is, from its first bytes (a link or a file name can say anything).
...
async function save(buf, want) {
  ...
  if (type === 'image/heic') throw new Error('That picture is HEIC (an iPhone photo), which browsers can’t show. Send it as a JPEG or PNG.');
